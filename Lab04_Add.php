...
<head>
	...
	<body style="font-family: Bahnschrift; position: relative; background-image: linear-gradient(rgba(255,255,255,1),rgba(155,155,155,0.30)), url(bg.png); background-size: 100%; background-position: center;">
		...
		<form method="post" action="Lab04_Add_Data.php">
			<br/><br/><br/><br/><br/><br/>
			<div style="text-align: center">
				...
				Add Data:<br/>
				<input type="text" name = "change" placeholder="Add Data..." size="50" onmouseover="this.style.background='whitesmoke';" onmouseout="this.style.background='white';">
			</div>
