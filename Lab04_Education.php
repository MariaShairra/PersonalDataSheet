...
<head>
	...
	<body style="font-family: Bahnschrift; position: relative; background-image: linear-gradient(rgba(255,255,255,1),rgba(155,155,155,0.30)), url(bg.png); background-size: 100%; background-position: center;">
		...
		<br><br>
		<p style = "color: Orange; font-size: 45px; padding-top: 10px; text-align: center"><b>Applicant's Education Information</b></p>
		<?php
		   ...
		   <tr> <thead>
			  ...
			  <th style = "padding: 10px; border-style: hidden;">Delete</th>
				...
				<?php $num = $row['TIN'];
				echo "<td><form method='post' action='Lab09_Delete_data.php'><input type='hidden' value='$num' name='id'><button style='background-color: #4CAF50; border: 0.5 solid black; border-radius: 3px'>Add</button></form></td>";?>
				<?php $num = $row['TIN'];
				echo "<td><form method='post' action='Lab09_Delete_data.php'><input type='hidden' value='$num' name='id'><button style='background-color: blue; border: 0.5 solid black; border-radius: 3px'>Edit</button></form></td>";?>
				<?php $num = $row['TIN'];
				echo "<td><form method='post' action='Lab09_Delete_data.php'><input type='hidden' value='$num' name='id'><button style='background-color: red; border: 0.5 solid black; border-radius: 3px';>Delete</button></form></td>";?>
				</tr>
				<tr>
				<td>Secondary</td>
